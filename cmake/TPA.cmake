...
function(TPA_set _name _value)
    ...
    # update index
    if (NOT _name STREQUAL "_TPA_INDEX_KEY")
        TPA_index(_index)
...
function(set_tpa_property _prefix _property _value)
    TPA_set("${_prefix}_${_property}" "${_value}")
endfunction()
