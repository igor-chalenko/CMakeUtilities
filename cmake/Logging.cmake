...
function(log_message _level _category _message)
    ...
    if (NOT _current_level OR _current_level LESS_EQUAL ${_ind})
        ...
        if (_level STREQUAL FATAL)
            message(FATAL_ERROR "${_message_prefix} ${_formatted_message}")
        elseif (_level STREQUAL ERROR)
            message(SEND_ERROR "${_message_prefix} ${_formatted_message}")
        else()
...
function(_log_parent_level _category _out_var)
    if(_category MATCHES "(.+)\\.(.+)")
        ...
        _log_levels(_levels)
        list(FIND _levels WARN _ind)
        set(${_out_var} ${_ind} PARENT_SCOPE)
    endif()
endfunction()
...
function(_log_levels _out_var)
    set(${_out_var} "TRACE;DEBUG;INFO;WARN;ERROR;FATAL" PARENT_SCOPE)
endfunction()
